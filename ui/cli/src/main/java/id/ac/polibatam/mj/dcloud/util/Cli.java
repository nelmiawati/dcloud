    ...
    private String execUpload() {
        ...
        try {
            ...
            if (opts.length < 4) {
                ...
                File[] dispersedFile = null;
                try {

                    // Validate fromLocal
                    final File input = new File(fromLocal);
                    ...
                    pw.println(":: UPLOAD FILE [" + fromLocal + "] AT LOCAL INTO FILE [" + toRemote + "] AT DCLOUD SERVERS ::");
