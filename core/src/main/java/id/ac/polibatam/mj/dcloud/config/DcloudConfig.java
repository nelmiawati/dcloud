...
public class DcloudConfig extends APlainConfig {
    ...
    public enum Param implements IParam {
        ...
        DCLOUD_LOCAL_WORKSPACE("dcloud-local-workspace", "default-workspace", ".+"), DCLOUD_USE_SALT("dcloud-use-salt", "false", "^([Tt][Rr][Uu][Ee]|[Ff][Aa][Ll][Ss][Ee])$"), DCLOUD_COUNT("dcloud-count", "4",
