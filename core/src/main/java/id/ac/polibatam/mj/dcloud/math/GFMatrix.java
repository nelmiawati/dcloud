...
public class GFMatrix {
     ...
     * 112, pp.893-903, 1970.
     *
     * @param v the vector which describe the Vandermonde matrix.
     * @param b right-hand side of the Vandermonde system equation.
     * @return x.
     * @throws DcloudInvalidDataRuntimeException if v or b is invalid.
     */
     ...
     *
     * @param v the vector which describe the Vandermonde matrix.
     * @param f right-hand side of the Vandermonde system equation.
     * @return a.
     * @throws DcloudInvalidDataRuntimeException if v or f is invalid.
     */
